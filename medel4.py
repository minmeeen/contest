...
# # Train
# model.fit(train_data, epochs=30, validation_data=val_data, callbacks=[checkpoint])
...
checkpoint = ModelCheckpoint('model4.h5', verbose=1, monitor='val_accuracy',save_best_only=True, mode='max')
